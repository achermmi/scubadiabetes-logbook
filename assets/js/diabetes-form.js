...
(function($) {
    ...
    $(document).ready(function() {
        ...
        function applyUnitToUI() {
            ...
            $('.sd-glic-label').each(function() {
                $(this).text('GLIC (' + label.toUpperCase() + ')');
            });

            // Update input attributes
            $('.sd-glic-input').each(function() {
                $(this).attr({
                    min: cfg.min,
                    max: cfg.max,
                    step: cfg.step,
        ...
        // METHOD TOGGLE C / S
        // ============================================================
        $(document).on('click', '.sd-method-btn', function(e) {
            e.preventDefault();
            var $btn = $(this);
        ...
        function drawChart() {
            ...
            var xPositions = xLabels.map(function(_, i) {
            ...
            var validPoints = values.filter(function(v) { return v !== null; });
        ...
        $(document).on('input change', '.sd-glic-input', function() {
            drawChart();
            evaluateDecision();
        });
        $(document).on('click', '.sd-method-btn', function() {
