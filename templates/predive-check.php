...
<div class="sd-form-wrap sd-predive-wrap" id="sd-predive-widget"
	...
	<p class="sd-predive-disclaimer">
		<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor"
		     stroke-width="2" style="vertical-align:middle;margin-right:4px;opacity:.7;">
			<circle cx="12" cy="12" r="10"/>
			<line x1="12" y1="8" x2="12" y2="12"/>
			<line x1="12" y1="16" x2="12.01" y2="16"/>
		</svg>
		<?php esc_html_e( 'Questo strumento è un supporto decisionale e non sostituisce il giudizio clinico del tuo medico. Segui sempre le indicazioni del protocollo Diabete Sommerso.', 'sd-logbook' ); ?>
	</p>
