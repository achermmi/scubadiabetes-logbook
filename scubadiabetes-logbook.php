...
final class SD_Logbook
{
    ...
    {
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-database.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-roles.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-dive-form.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-dashboard.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-diver-profile.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-medical-panel.php';
        include_once SD_LOGBOOK_PLUGIN_DIR . 'includes/class-sd-research-dashboard.php';
    }
    ...
    private function is_plugin_page()
    {
        ...
        $shortcodes = array( 'sd_dive_form', 'sd_dashboard', 'sd_diver_profile', 'sd_medical_panel', 'sd_research_dashboard' );
