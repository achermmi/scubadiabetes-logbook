...
= 1.4.3 =
* Fatture soci: aggiunto sotto i dati Swiss QR l'avviso in grassetto per i pagamenti da istituti bancari svizzeri.
...
= 1.4.0 =
* Modifica: il riferimento Swiss QR delle fatture soci usa il numero socio al posto del numero fattura.

= 1.3.99 =
* Nuovo: generazione automatica del codice Swiss QR nelle fatture soci con importo della tassa associativa, dati PostFinance e riferimento annuale comprensivo del numero fattura.

= 1.3.98 =
* Feat: allegati multipli in mailing list soci e invio e-mail attività — i select "Modelli PDF" ora supportano selezione multipla (Ctrl+clic).

= 1.3.97 =
* Fix: il PDF del template Designer selezionato nel cruscotto registrazioni viene ora allegato alle e-mail broadcast (singola, massiva, tutte le pagate).
